...
time_list = [16, 17, 18, 15, 20, 19, 21]
...
min_dict = {time_list[0]: 6000, time_list[1]: 10000, time_list[2]: 13000, time_list[3]: 0, time_list[4]: 0, time_list[5]: 0, time_list[6]: 0}
# 最大步数（例如现在设置意思是在8点（你设置的第一个时间点默认8）运行会在1500到2999中随机生成一个数提交（开启气候降低步数会乘系数K）10点3000~4999。。。以此类推，步数范围建议看懂了再改，没看懂直接默认就好）
max_dict = {time_list[0]: 9999, time_list[1]: 19999, time_list[2]: 19999, time_list[3]: 0, time_list[4]: 0, time_list[5]: 0, time_list[6]: 0}
# 设置结束
