...
time_list = [15, 16, 17, 18, 19, 20, 21]
...
min_dict = {time_list[0]: 6000, time_list[1]: 10000, time_list[2]: 11000, time_list[3]: 12000, time_list[4]: 13000, time_list[5]: 13500, time_list[6]: 14000}
# 最大步数（例如现在设置意思是在8点（你设置的第一个时间点默认8）运行会在1500到2999中随机生成一个数提交（开启气候降低步数会乘系数K）10点3000~4999。。。以此类推，步数范围建议看懂了再改，没看懂直接默认就好）
max_dict = {time_list[0]: 9999, time_list[1]: 11000, time_list[2]: 12000, time_list[3]: 13000, time_list[4]: 13500, time_list[5]: 14000, time_list[6]: 14500}
# 设置结束
